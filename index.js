...
import { Image, ImageCaption, ImageInsert, ImageAgentbar, ImageUpload } from '@ckeditor/ckeditor5-image';
...
import { Table, TableAgentbar } from '@ckeditor/ckeditor5-table';
...
class GenerateJSONEntry extends Plugin {
    init() {
        ...
        // to be displayed in the agentbar.
...
window.addEventListener("load", async (event) => {
	...
	const editor = await ClassicEditor.create(elem, {
		...
		table: {
			contentAgentbar: ['tableColumn', 'tableRow', 'mergeTableCells'],
		},
		// wproofreader: {
